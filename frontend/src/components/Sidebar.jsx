...
export default function Sidebar({ documents, stats, onUpload, onDelete, onLoadSamples, onPreview }) {
  ...
  return (
    <aside className="w-[320px] border-r border-border bg-surface flex flex-col shrink-0">
      ...
      <DocumentList documents={filtered} onDelete={onDelete} onPreview={onPreview} />
